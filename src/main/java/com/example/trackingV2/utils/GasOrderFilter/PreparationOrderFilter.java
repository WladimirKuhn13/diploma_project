...
public class PreparationOrderFilter implements GasOrderFilter {
    private static final Set<String> STATUSES = Set.of(StatusGasOrder.TRANSFERRED_TO_PREPARATION_AREA.getStatus(), StatusGasOrder.ACCEPTED_AT_PREPARATION_AREA.getStatus());
